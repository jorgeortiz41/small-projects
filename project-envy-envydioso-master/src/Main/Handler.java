...
//		width = (DEFAULTWIDTH/1920)*1920;
	...
	public BaseDynamicEntity newEntity(Handler handler, int xPosition, int yPosition, String state,String area,String name,BufferedImage[] animFrames ){
			Merchant m = new Merchant(handler, xPosition, yPosition,state, area, name, animFrames);
			return m;
		}
