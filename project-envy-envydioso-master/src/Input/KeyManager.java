...
public class KeyManager implements KeyListener {
	...
	public boolean debugbutt = false;
	public boolean statdebugbutt = false;
	public boolean questbutt = false;
	public KeyManager(){
	...
	public void tick(){
		...
		debugbutt = keys[KeyEvent.VK_F7];
		statdebugbutt = keys[KeyEvent.VK_H];
		questbutt = keys[KeyEvent.VK_E];
	}
