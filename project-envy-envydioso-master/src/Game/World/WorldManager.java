...
import Game.Entities.Dynamics.Merchant;
import Game.Entities.Dynamics.Player;
import Game.Entities.Statics.SmokeHouse;
import Game.Entities.Statics.Tree;
import Game.Entities.Statics.Alien;
...
public class WorldManager {
	...
	public WorldManager(Handler handler, EntityManager entityManager) {
		...
		if((Player.skill == "Freeze")) {
			this.entityManager.AddEntity(new Alien(handler, 1460, 80));
		}else {
			this.entityManager.AddEntity(new Alien(handler, 1660, 80));
		...
		this.entityManager.AddEntity(handler.newEnemy(Images.MEnemyIdle,handler,2400, -200,"MapState","Jovan","None","Mewtwo",300,25,50,1,9,15,20,10,20,10,1,5,"None","Fire",null,null)); // lvl 0 dificulty
	...
	private void AddWalls() {
		...
		worldWalls.add(new Walls(handler, 1150, 545, 50, 50, "Door Town")); // Town Rectangle
		...
		if((Player.skill == "Freeze")) {
			worldWalls.add(new Walls(handler, 1460, 80, 50, 75, "Wall"));
		}else {
				worldWalls.add(new Walls(handler, 1662, 105, 50, 75, "Wall"));
		}
		///Left Mountains
