...
public class Mewtwo extends BaseHostileEntity implements Fighter{
	...
	public Mewtwo(Handler handler, int xPosition, int yPosition, String state,String area,String name,BufferedImage[] animFrames ){
		super(handler, xPosition, yPosition, state, area, name,animFrames);
		width = 50;
		height = 50;
		speed = 1;
		type="Mewtwo";
	...
	public void render(Graphics g) {
		...
		if(handler.getArea().equals(this.Area)) {
            ...
            g.drawImage(Images.mew2,Mewtwo.x,Mewtwo.y,Mewtwo.width,Mewtwo.height,null);
    ...
    double health=300,mana=100,xp=01,lvl=1,defense=12,str=9,intl=20, mr = 10,cons=20,acc=10,evs=2,initiative=10, maxHealth = 200;
