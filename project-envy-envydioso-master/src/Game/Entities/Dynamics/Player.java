...
public class Player extends BaseDynamicEntity implements Fighter {
	...
	public static boolean quest1 = false;
	...
	private void PlayerInput() {
		...
		//DEBUG Key!
		if (handler.getKeyManager().debugbutt && GameSetUp.DEBUGMODE == false) {
			GameSetUp.DEBUGMODE = true;
		}else if (handler.getKeyManager().debugbutt && GameSetUp.DEBUGMODE == true) {
			GameSetUp.DEBUGMODE = false;
		}
		//Debug Full Health & Mana!
		if (handler.getKeyManager().statdebugbutt /* && GameSetUp.DEBUGMODE == true*/) {
			health = 200;
			mana = 100;
		}
	...
	String Class = "none";
	public static String skill = "none";
