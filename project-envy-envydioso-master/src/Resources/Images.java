...
public class Images {
	...
	public static BufferedImage zard;
	public static BufferedImage mew2;
	public static BufferedImage[] alien_front;
	public static SpriteSheet playerSheet;
	public static SpriteSheet mewtwo;
	...
	public static SpriteSheet MEnemySheet;
	...
	public Images() {
		...
		MEnemyIdle = new BufferedImage[7];
		...
		try {
			...
			MEnemySheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/mew2idle.png")));
			...
			zard = ImageIO.read(getClass().getResourceAsStream("/Sheets/zard.png"));
			mew2 = ImageIO.read(getClass().getResourceAsStream("/Sheets/mew2.png"));


			TownMap = ImageIO.read(getClass().getResourceAsStream("/Worlds/village2.jpg"));
			...
			MEnemyIdle[0] = MEnemySheet.crop(66, 14, 138, 133);
			MEnemyIdle[1] = MEnemySheet.crop(223, 13, 138, 133);
			MEnemyIdle[2] = MEnemySheet.crop(378, 16, 138, 133);
			MEnemyIdle[3] = MEnemySheet.crop(501, 9, 138, 133);
			MEnemyIdle[4] = MEnemySheet.crop(629, 13, 138, 133);
			MEnemyIdle[5] = MEnemySheet.crop(767, 10, 138, 133);
			MEnemyIdle[6] = MEnemySheet.crop(908, 14, 138, 133);
			...
			alien = ImageIO.read(getClass().getResourceAsStream("/Sheets/2d.png"));
			/*alien_front[0] = alien.crop(1, 6, 143, 152);
			alien_front[1] = alien.crop(17, 7, 15, 27);
			alien_front[2] = alien.crop(33, 6, 15, 27);
			alien_front[3] = alien.crop(49, 7, 15, 27);*/
			//
