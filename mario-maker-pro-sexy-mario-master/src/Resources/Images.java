...
public class Images {
    ...
    public static BufferedImage[] mariobroSmallWalkLeft;
    public static BufferedImage[] mariobroSmallWalkRight;
    public static BufferedImage[] mariobroSmallJumpLeft;//also store ide sprites like looking up or down
    public static BufferedImage[] mariobroSmallJumpRight;

    public static BufferedImage[] mariobroBigWalkLeft;
    public static BufferedImage[] mariobroBigWalkRight;
    public static BufferedImage[] mariobroBigRunLeft;
    public static BufferedImage[] mariobroBigRunRight;
    public static BufferedImage[] mariobroBigJumpLeft;//also store ide sprites like looking up or down and left<->right transition
    public static BufferedImage[] mariobroBigJumpRight;
    ...
    public static SpriteSheet gameoverSheet;
    ...
    private SpriteSheet mariobroSpriteSheet;
    ...
    public Images() {
        ...
        try {
            ...
            mariobroSpriteSheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/marioSNESSheet2.png")));
...
//            //player sprites
//            //Small
//            mariobroSmallWalkLeft[0] = mariobroSpriteSheet.crop(169,0,14,20);
//            mariobroSmallWalkLeft[1] = mariobroSpriteSheet.crop(49,0,15,19);
//
//            mariobroSmallWalkRight[0] = mariobroSpriteSheet.crop(209,0,14,20);
//            mariobroSmallWalkRight[1] = mariobroSpriteSheet.crop(328,0,15,19);
//
//            mariobroSmallJumpLeft[0] = mariobroSpriteSheet.crop(168,39,16,22);
//            mariobroSmallJumpLeft[1] = mariobroSpriteSheet.crop(128,40,16,20);
//            mariobroSmallJumpLeft[2] = mariobroSpriteSheet.crop(49,39,15,21);//up
//            mariobroSmallJumpLeft[3] = mariobroSpriteSheet.crop(89,43,15,14);//down
//
//            mariobroSmallJumpRight[0] = mariobroSpriteSheet.crop(208,39,16,22);
//            mariobroSmallJumpRight[1] = mariobroSpriteSheet.crop(248,40,16,20);
//            mariobroSmallJumpRight[2] = mariobroSpriteSheet.crop(328,39,15,21);//up
//            mariobroSmallJumpRight[3] = mariobroSpriteSheet.crop(288,43,15,14);//down
//
//            // Big
//            mariobroBigWalkLeft[0] = mariobroSpriteSheet.crop(169,76,15,28);
//            mariobroBigWalkLeft[1] = mariobroSpriteSheet.crop(8,76,16,28);
//
//            mariobroBigWalkRight[0] = mariobroSpriteSheet.crop(208,76,15,28);
//            mariobroBigWalkRight[1] = mariobroSpriteSheet.crop(368,76,16,28);
//
//            mariobroBigRunLeft[0] = mariobroSpriteSheet.crop(169,76,15,28);
//            mariobroBigRunLeft[1] = mariobroSpriteSheet.crop(48,76,16,27);
//
//            mariobroBigRunRight[0] = mariobroSpriteSheet.crop(208,76,15,28);
//            mariobroBigRunRight[1] = mariobroSpriteSheet.crop(328,76,16,27);
//
//            mariobroBigJumpLeft[0] = mariobroSpriteSheet.crop(168,114,16,31);
//            mariobroBigJumpLeft[1] = mariobroSpriteSheet.crop(128,115,16,29);
//            mariobroBigJumpLeft[2] = mariobroSpriteSheet.crop(129,196,15,27);//up
//            mariobroBigJumpLeft[3] = mariobroSpriteSheet.crop(88,122,16,15);//down
//            mariobroBigJumpLeft[4] = mariobroSpriteSheet.crop(8,115,16,29);//change
//
//            mariobroBigJumpRight[0] = mariobroSpriteSheet.crop(208,114,16,31);
//            mariobroBigJumpRight[1] = mariobroSpriteSheet.crop(248,115,16,29);
//            mariobroBigJumpRight[2] = mariobroSpriteSheet.crop(248,196,15,27);//up
//            mariobroBigJumpRight[3] = mariobroSpriteSheet.crop(287,122,16,15);//down
//            mariobroBigJumpRight[4] = mariobroSpriteSheet.crop(368,115,16,29);//Change
            ...
            noteBlock = interactableSpriteSheet.crop(71,130,20,20);
            cloudBlock = interactableSpriteSheet.crop(110,130,20,20);
            gameover = gameoverSheet.crop(14, 7, 256, 223);
            ...
            star = interactableSpriteSheet.crop(90, 10, 21, 23);
